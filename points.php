...
<head>
    ...
    <link rel="stylesheet" href="styles/pointsStyles.css">
...
<body>
    <div class="menu">
        ...
        <a class="menu-button" id="link2" href="tippen">
            <div class="menu-item">Tippen</div>
        </a>
        <a class="menu-button selected" aria-disabled="true">
            <div class="menu-item selected">Punkte</div>
        </a>
    ...
    <script src="scripts/points.js?v=3"></script>
</body>
</html>