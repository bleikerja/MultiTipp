...
foreach ($users as $user) {
    ...
    $auth = [
        'VAPID' => [
            ...
            'publicKey' => 'BDzyRQ8uYHRuucJ3MoLx-YNlsRFrg8EpU4lajmNQq-ZDdJYLjXpYSiB1giuzK6EDnTiq98fUm03yHzPYRbEaTQA',
            'privateKey' => 'ZaCG6IHEd1BXu4y8MEWg4MTgKcIPY0y2u7dRrhIUiA8',
        ],
    ];
